...
extension Diffing where Value == UIImage {
  ...
  public static func image(precision: Float, scale: CGFloat?, allowedDifference: UInt8 = 0) -> Diffing {
...
extension Snapshotting where Value == UIImage, Format == UIImage {
  ...
  public static func image(precision: Float, scale: CGFloat?, allowedDifference: UInt8 = 0) -> Snapshotting {
    return .init(
      pathExtension: "png",
      diffing: .image(precision: precision, scale: scale, allowedDifference: allowedDifference)
    )
  }
}
